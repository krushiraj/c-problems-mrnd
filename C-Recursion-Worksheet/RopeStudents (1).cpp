...
they will go for a crazy pyramid Kind Formation ,where initially there will be one leaderStudent who will be tied up with 
3 other students ,
These 3 students will each be tied up with 3 more students , and this goes on till all students are tied up .

Example : Let A be the leader student , He is tied up with {B,C,D} and B is tied up with {E,F,G} , C tied up with {H,I,J}
, D tied up with {K,L,M} .
From E to M they are tied up with no further students .

Now they will play a game where leaderStudent will pass a ball to one of the students he got tied up with , Assume 
A passed the ball to either B,C, or D .[Let it be D]
Now D will can pass the ball to  either K,L, or M .Let let it be L . Now L cant pass the ball anymore further .So the
ball can be in the hands of Max of 3 people [A,D,L]
before it is stopped . This is called as ****maxBallDistance ****. No matter whom A passes the ball first ,It reaches
the end after making 2 passes ,ie total of 3 people
have holded the ball [including A]

Example Image Link : https://goo.gl/hjE5ec


Now students being restless ,some of them got bored , and escaped cutting of their Ropes . If a student has escaped 
,All the following students who are tied up with him
are free and they have also escaped , Like if B cutoff the Rope between A and B , All of B, and his successors [E,F,G]
have also escaped .

Now in this example let us assume E,F,G has escaped , Now A can pass ball to either B,C or D ,But if A passes ball to B 
,it will stop their itself as all of B's
successors have escaped ,Now the ball has been holded by 2 people ,If A has passed the ball to either C or D ,it can be
passed one more time ,but in case A passed to B
...
***
Now given a formation of Students , can you help the Bharath find the minBallDistance and maxBallDistance . 
Only distances are needed , no need of studentsNames.
***
