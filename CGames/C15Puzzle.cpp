...
void c15Puzzle_main(){
	...
	/*printf("enter values for rows and cols\n");
	scanf("%d\n", &rows);
	scanf("%d\n", &cols);*/
	Board *temp = createBoard(rows, cols);
	//printf("krushi");
	int table[4][4] = { 4, 2, 3, 15, 5, 7, 1, 8, 9, 6, 11, 12, 13, 10, 14, 0 };
